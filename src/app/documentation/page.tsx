                ...
                <div className="mt-8">
                  ...
                  <ul className="space-y-3">
                    <li className="flex gap-3 items-start">
                      ...
                      <div>
                        <a href="#hge-architecture" className="text-foreground hover:text-accent transition-colors font-medium">
                          HGE architecture overview
                        </a>
                        <span className="ml-2 text-xs text-muted-foreground italic">(in progress)</span>
                      </div>
                    </li>
                    <li className="flex gap-3 items-start">
                      <span className="text-accent mt-1">→</span>
                      <div>
                        <a href="#experiment-spec-schema" className="text-foreground hover:text-accent transition-colors font-medium">
                    ...
                    <li className="flex gap-3 items-start">
                      <span className="text-accent mt-1">→</span>
                      <div>
                        <a href="#instrument-backend" className="text-foreground hover:text-accent transition-colors font-medium">
                    ...
                    <li className="flex gap-3 items-start">
                      <span className="text-accent mt-1">→</span>
                      <div>
                        <a href="#validation-workflow" className="text-foreground hover:text-accent transition-colors font-medium">
            ...
            <section>
              ...
              <div className="space-y-4 text-base text-foreground font-body leading-relaxed">
                ...
                <div className="mt-8 bg-card border border-border rounded-lg p-6">
                  <svg className="w-full h-48" viewBox="0 0 800 200" xmlns="http://www.w3.org/2000/svg">
                    <defs>
                    ...
                    {/* Design */}
                    <rect x="20" y="60" width="140" height="80" fill="white" stroke="#cbd5e1" strokeWidth="1.5" rx="4" />
                    <text x="90" y="90" textAnchor="middle" fill="#1e293b" fontSize="14" fontWeight="600">Design</text>
                    <text x="90" y="110" textAnchor="middle" fill="#64748b" fontSize="11">Documentation creation</text>
                    <text x="90" y="125" textAnchor="middle" fill="#64748b" fontSize="11">and initial validation</text>
                    
                    {/* Validate */}
                    <rect x="200" y="60" width="140" height="80" fill="white" stroke="#cbd5e1" strokeWidth="1.5" rx="4" />
                    <text x="270" y="90" textAnchor="middle" fill="#1e293b" fontSize="14" fontWeight="600">Validate</text>
                    <text x="270" y="110" textAnchor="middle" fill="#64748b" fontSize="11">Version control and</text>
                    <text x="270" y="125" textAnchor="middle" fill="#64748b" fontSize="11">change management</text>
                    
                    {/* Maintain */}
                    <rect x="380" y="60" width="140" height="80" fill="white" stroke="#cbd5e1" strokeWidth="1.5" rx="4" />
                    <text x="450" y="90" textAnchor="middle" fill="#1e293b" fontSize="14" fontWeight="600">Maintain</text>
                    <text x="450" y="110" textAnchor="middle" fill="#64748b" fontSize="11">Controlled distribution</text>
                    <text x="450" y="125" textAnchor="middle" fill="#64748b" fontSize="11">and access</text>
                    
                    {/* Govern */}
                    <rect x="560" y="60" width="140" height="80" fill="white" stroke="#cbd5e1" strokeWidth="1.5" rx="4" />
                    <text x="630" y="90" textAnchor="middle" fill="#1e293b" fontSize="14" fontWeight="600">Govern</text>
                    <text x="630" y="110" textAnchor="middle" fill="#64748b" fontSize="11">Review cycles and</text>
                    <text x="630" y="125" textAnchor="middle" fill="#64748b" fontSize="11">continuous updates</text>
                    
                    {/* Arrows */}
                    <line x1="165" y1="100" x2="195" y2="100" stroke="#94a3b8" strokeWidth="1.5" markerEnd="url(#arrow)" />
                    <line x1="345" y1="100" x2="375" y2="100" stroke="#94a3b8" strokeWidth="1.5" markerEnd="url(#arrow)" />
                    <line x1="525" y1="100" x2="555" y2="100" stroke="#94a3b8" strokeWidth="1.5" markerEnd="url(#arrow)" />
                    
                    {/* Continuous improvement line */}
                    <line x1="90" y1="155" x2="630" y2="155" stroke="#cbd5e1" strokeWidth="1" strokeDasharray="4,4" />
                    <text x="360" y="175" textAnchor="middle" fill="#94a3b8" fontSize="10" fontStyle="italic">continuous improvement applied across all stages</text>
                  </svg>

        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-lg font-body text-muted-foreground">
              HGE technical materials are maintained internally and shared selectively with
              qualified research partners and institutional collaborators.
            </p>
          </div>
              ...
              <div className="flex items-start space-x-4 mb-6">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-base font-body text-muted-foreground leading-relaxed mb-4">
                    Project HGE technical papers, system documentation, and validation materials are
                    maintained internally and shared selectively with research partners, funding
                    agencies, and institutional collaborators.
                  </p>
                  <p className="text-sm font-body text-muted-foreground leading-relaxed">
                    Public releases will follow peer review, partner validation, and governance
                    review.
                  </p>
                </div>
              </div>
          ...
          <div className="mt-8 bg-muted border border-border rounded-sm p-6">
            <div className="flex items-start space-x-3">
              ...
              <p className="text-sm font-body text-muted-foreground">
                Research briefings are provided to qualified partners following institutional
                review. Materials are shared under appropriate confidentiality and collaboration
                frameworks.
              </p>
            </div>
          </div>

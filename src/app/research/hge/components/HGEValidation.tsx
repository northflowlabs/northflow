        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-lg font-body text-muted-foreground">
              HGE is currently being validated in a demanding physical environment to stress-test
              its methodology under real-world operational constraints.
            </p>
          </div>
          ...
          <div className="bg-background border border-border rounded-sm p-8">
            <div className="flex items-start space-x-4 mb-6">
              ...
              <div>
                ...
                <p className="text-base font-body text-muted-foreground leading-relaxed">
                  The methodology is being validated using live remote quantum computing hardware.
                  Quantum systems present significant operational challenges: high noise levels,
                  temporal drift, calibration uncertainty, and limited coherence times. These
                  characteristics make quantum hardware a rigorous test environment for validating
                  HGE's ability to function under adverse physical conditions.
                </p>
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start space-x-3">
                ...
                <span className="text-sm font-body text-foreground">
                  Objective: demonstrate instrument-agnostic methodology in physically constrained
                  setting
                </span>
              </div>
            </div>
          ...
          <div className="mt-8 p-4 bg-muted border border-border rounded-sm">
            <p className="text-sm font-body text-muted-foreground">
              <span className="font-semibold text-foreground">Note:</span> Quantum hardware is used
              as a validation environment for the methodology, not as the primary application
              domain. The goal is to stress-test HGE's approach in a physically demanding context.
            </p>
          </div>
        </div>
      </div>

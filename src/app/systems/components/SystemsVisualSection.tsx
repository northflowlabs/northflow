      ...
      <div className="max-w-[1400px] mx-auto px-8">
        <div className="mb-8">
          ...
          <p className="text-sm text-muted-foreground font-body leading-relaxed text-center max-w-3xl mx-auto">
            The diagram below is illustrative and conceptual. It represents design principles and
            architectural intent, not deployed systems, products, or operational environments.
          </p>
        </div>
        ...
        <div className="mt-6 max-w-4xl mx-auto text-center">
          <p className="text-sm text-muted-foreground font-body leading-relaxed">
            Research outputs inform system design, implementation planning, and institutional
            dialogue across infrastructure contexts.
          </p>
        </div>
      </div>
    </section>

      ...
      <div className="max-w-[1400px] mx-auto px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-base text-muted-foreground font-body max-w-2xl mx-auto">
            Our institutional engagement follows a structured, transparent process designed for
            government entities and qualified stakeholders.
          </p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {guidelines.map((guideline) => (
            <div key={guideline.id} className="bg-card p-6 rounded-sm border border-border">
        ...
        <div className="mt-16 max-w-3xl mx-auto">
          <div className="bg-card p-8 rounded-sm border border-border">
            ...
            <div className="space-y-4 text-sm text-muted-foreground font-body">
              <p>
                <strong className="text-foreground">For urgent institutional matters:</strong>{' '}
                Direct communication channels may be established following initial engagement
                review.
              </p>
              <p>
                <strong className="text-foreground">For research collaboration inquiries:</strong>{' '}
                Please reference Northflow Research Lab on the{' '}
                <a href="/research" className="text-primary hover:underline">
                  Research page
                </a>{' '}
                for academic and policy research partnerships.
              </p>
              <p>
                <strong className="text-foreground">For media inquiries:</strong> Please use the
                general contact form and specify "Media Inquiry" in your dialogue intent.
              </p>
            </div>
          </div>
        </div>

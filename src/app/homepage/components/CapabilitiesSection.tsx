...
const CapabilitiesSection = ({ className = '' }: CapabilitiesSectionProps) => {
  const capabilities: Capability[] = [
  {
    ...
    description: 'Governable digital infrastructure designed for regulated environments with comprehensive audit capabilities.',
    metrics: 'Designed to align with ISO/IEC 27001',
  ...
  },
  {
    ...
    description: 'Northflow Research Lab advances sovereign technology frameworks through applied research and policy analysis.',
    metrics: 'NRL Publications',
  ...
  },
  {
    ...
    description: 'European presence with local compliance expertise and institutional relationship frameworks.',
    metrics: 'GDPR-aligned data protection approach',
    backgroundImage: "/assets/images/Built_in_Norway_and_operating_across_Europe-1767115614475.jpg",
    backgroundAlt: 'Modern institutional buildings representing Nordic and European operational context'
  }];
      ...
      <div className="max-w-[1400px] mx-auto px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground font-body max-w-3xl mx-auto">
            Comprehensive infrastructure solutions for government entities and mission-critical stakeholders.
          </p>
        </div>

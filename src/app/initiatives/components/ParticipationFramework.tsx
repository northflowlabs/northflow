...
export default function ParticipationFramework() {
  ...
  const participationTypes: ParticipationType[] = [
    {
      ...
      description: 'Organisations contributing insight, requirements, and operational perspective during the early design phase of strategic frameworks.',
    ...
    },
    {
      ...
      description: 'Institutions contributing research input, methodological perspective, or domain expertise relevant to sovereign digital infrastructure and institutional systems.',
    ...
    },
    {
      ...
      description: 'Organisations exploring limited-scope pilots or validation exercises to test selected framework components in controlled contexts.',
    ...
    },
    {
      ...
      description: 'Stakeholders following initiative development to assess relevance, maturity, and potential future engagement pathways.',
  ...
  const engagementProcess = [
    ...
    },
    {
      ...
      description: 'Presentation of initiative objectives, development stage, and engagement options.',
      icon: 'PresentationChartLineIcon'
    },
    {
      step: '4',
      title: 'Engagement pathway',
      description: 'Clarification of next steps, dialogue structure, and contribution opportunities.',
      ...
      <div className="max-w-[1400px] mx-auto px-8">
        <div className="mb-12">
          ...
          <p className="text-lg text-muted-foreground font-body max-w-3xl">
            Structured dialogue pathways enabling qualified organisations to contribute to framework development and exploration.
          </p>
        </div>
              ...
              <div className="p-6">
                <div className="flex items-start justify-between mb-4">
                  <div className="w-12 h-12 bg-primary/10 rounded-sm flex items-center justify-center flex-shrink-0">
                    <Icon name={type.icon as any} size={24} variant="outline" className="text-primary" />
                  </div>
                  <button
                ...
                <p className="text-sm font-body font-medium text-primary mb-3">
                  {type.subtitle}
                </p>
                ...
                <div className="flex items-start space-x-2 text-sm text-muted-foreground mb-4">
                  <Icon name="ClipboardDocumentListIcon" size={16} variant="outline" className="flex-shrink-0 mt-0.5" />
                      ...
                      <ul className="space-y-2">
                        {type.eligibility.map((item, idx) => (
                          <li key={idx} className="flex items-start space-x-2">
                            <Icon name="CheckCircleIcon" size={16} variant="outline" className="text-primary mt-0.5 flex-shrink-0" />
                    ...
                    <div>
                      ...
                      <ul className="space-y-2">
                        {type.participation.map((item, idx) => (
                          <li key={idx} className="flex items-start space-x-2">
                            <Icon name="ArrowRightIcon" size={16} variant="outline" className="text-primary mt-0.5 flex-shrink-0" />
                            <span className="text-sm text-foreground font-body">{item}</span>
                          </li>
                        ))}
                      </ul>
        ...
        <div className="mb-16">
          ...
          <p className="text-sm text-muted-foreground font-body text-center mb-8 max-w-2xl mx-auto">
            Engagement follows a structured dialogue process designed to clarify scope, relevance, and potential next steps.
          </p>
              ...
              <div key={index} className="relative">
                <div className="bg-card border border-border rounded-sm p-6 h-full">
                  <div className="flex items-center space-x-3 mb-4">
                    ...
                    <Icon name={step.icon as any} size={20} variant="outline" className="text-primary" />
                  </div>
                ...
                {index < engagementProcess.length - 1 && (
                  <div className="hidden lg:block absolute top-1/2 -right-3 transform -translate-y-1/2">
                    <Icon name="ArrowRightIcon" size={20} variant="outline" className="text-border" />
                  </div>
                )}
              </div>
            ))}
        ...
        <div className="bg-primary/5 border border-primary/20 rounded-sm p-8">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg text-muted-foreground font-body mb-8 leading-relaxed">
              Qualified organisations interested in framework dialogue should submit enquiries through institutional engagement channels. Scope and alignment assessments conducted for all engagement requests.
            </p>
            <Link
              href="/engage"

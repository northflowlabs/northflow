...
const resources: Resource[] = [
  {
    ...
    topic: ['Project HGE', 'Gaia DR3', 'Validation artifacts', 'Deterministic replay'],
    publicationDate: '30 January 2026',
    description:
      'Technical summary documenting operational validation of HGE on Gaia DR3 astronomical catalog data, including deterministic execution outcomes, reproducibility constraints, and evidence-bundle structure.',
    href: '/research',
  ...
  },
  {
    ...
    type: 'Technical Papers',
    topic: ['Project HGE', 'Methodology', 'Hypothesis generation', 'Evidence systems'],
    publicationDate: 'January 2026',
    description:
      'Methodology note covering the Hypothesis Generation Engine architecture, structured discovery workflow, and verification methodology used for institutional review.',
    href: '/research/hge',
    availability: 'Public institutional materials',
  },
  {
    ...
    type: 'Documentation',
    topic: ['Evidence bundles', 'Verification workflows', 'Audit invariants'],
    publicationDate: 'January 2026',
    description:
      'Documentation for signed evidence bundle validation, deterministic replay constraints, and audit-grade verification workflows.',
    href: '/documentation',
    availability: 'Structured engagement',
  },
  {
    id: 'doc-002',
    title: 'Governance modes implementation',
    type: 'Documentation',
    topic: ['Governance modes', 'Policy gating', 'Institutional deployment'],
    publicationDate: 'January 2026',
    description:
      'Implementation guidance for configurable governance modes (disabled / logging / enforced) with operational controls for graduated institutional deployment.',
    href: '/documentation',
    availability: 'Structured engagement',
  },
  {
    ...
    type: 'Technical Papers',
    topic: ['Sentinel EO', 'Domain adapter', 'Wildfire risk', 'Deforestation'],
    publicationDate: 'Draft — March 2026 (expected)',
    description:
      'In-development framework for ESA Sentinel data adaptation into HGE workflows, including preprocessing interfaces and domain-specific hypothesis generation patterns.',
    href: '/research',
    availability: 'Structured engagement',
  },
  {
  ...
  },
  {
    ...
    description:
      'Operational resilience requirements, testing frameworks, and third-party risk management alignment references.',
    href: '/compliance',
    availability: 'Structured engagement',
  },
  {
